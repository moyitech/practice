    ...
    <div class="main-content">
      ...
      <div class="content-wrapper">
        <div class="page-header">
          <h2>碳资产开发</h2>
          <p class="page-description">开发和管理碳资产项目，包括CCER项目申报、审核和认证</p>
        </div>
        ...
        <div class="stats-grid">
          <div class="stat-card">
            <div class="stat-icon" style="background: #E5F9F0;">
              <i class="el-icon-folder-opened" style="color: #27A777;"></i>
            </div>
          ...
          <div class="stat-card">
            <div class="stat-icon" style="background: #E5F9F0;">
              <i class="el-icon-check" style="color: #27A777;"></i>
            </div>
            <div class="stat-content">
          ...
          <div class="stat-card">
            <div class="stat-icon" style="background: #E5F9F0;">
              <i class="el-icon-time" style="color: #27A777;"></i>
            </div>
            <div class="stat-content">
          ...
          <div class="stat-card">
            ...
            <div class="stat-content">
              <div class="stat-label">累计开发量</div>
              <div class="stat-value">15,678 tCO₂</div>
            </div>
          </div>
        </div>
        ...
        <div class="content-card">
          ...
          <el-table :data="projectList" style="width: 100%" stripe>
            ...
            <el-table-column prop="location" label="项目地点" width="150"></el-table-column>
            <el-table-column prop="expectedReduction" label="预计减排量 (tCO₂)" width="180"></el-table-column>
            ...
            <el-table-column label="操作" width="200">
              <template slot-scope="scope">
                ...
                <el-button v-if="scope.row.status === '待审核'" type="text" size="small" style="color: #27A777;">提交审核</el-button>
              </template>
            </el-table-column>
          </el-table>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      projectList: [
        {
          projectName: 'XX省XX市光伏发电项目',
          projectType: '光伏发电',
          location: 'XX省XX市',
          expectedReduction: '5,000.00',
          status: '进行中',
          createTime: '2024-01-20 10:30:00'
        },
        {
          projectName: 'XX省XX市风力发电项目',
          projectType: '风力发电',
          location: 'XX省XX市',
          expectedReduction: '3,500.00',
          status: '待审核',
          createTime: '2024-01-18 14:20:00'
        },
        {
          projectName: 'XX省XX市生物质能项目',
          projectType: '生物质能',
          location: 'XX省XX市',
          expectedReduction: '2,800.00',
          status: '已完成',
          createTime: '2024-01-15 09:15:00'
        },
        {
          projectName: 'XX省XX市森林碳汇项目',
          projectType: '森林碳汇',
          location: 'XX省XX市',
          expectedReduction: '4,200.00',
          status: '进行中',
